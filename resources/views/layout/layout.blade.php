...
<head>
    ...
    <link rel="icon" href="https://laravel.spruko.com/dashfox/ltr/assets/img/brand/favicon.png"
        type="image/x-icon" />
...
<body class="main-body light-theme app sidebar-mini active leftmenu-color">
                    ...
                    <div class="nav nav-item  navbar-nav-right ml-auto">
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <div class="dropdown-menu shadow">
                                ...
                                <a class="dropdown-item" href="/logout"><i class="fas fa-sign-out-alt"></i> Log
                                    Out</a>
                            </div>
                        </div>
    ...
    <div class="main-footer ht-40">
        <div class="container-fluid pd-t-0-f ht-100p">
            <span>Copyright © 2024 <a href="#">Akbar Medical Excellence Center </a></span>
        </div>
    </div>
    <!-- Footer closed -->
    <!-- Back-to-top -->
